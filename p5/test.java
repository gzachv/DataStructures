...
public class test {
	 ...
	 * @param [2] maximum load factor to give the the HashTable class.  
	 *            Note it is a fractional amount (e.g., 0.45), not the percent.
	 * @param [3] the initial size of the hashtable to give to HashTable class
	 * @param [4] maximum chain length to give the HashTable class.  To indicate
	 *            no maximum chain length, the value 0 will be given.
	 * @param [5] output file name used when calling the dump() or 
	 *            displayStats() methods 
	 */
